  ...
  render() {
    return(
      <div>
        ...
        <div className="row">
          <div
            className={this.props.exercise === "little" ? "col-md-2 ex-btn active-box" : "col-md-2 ex-btn"}
            onClick={() => { this.props.eventEmitter.emit("updateExercise", "little") }}
            >Little Exercise</div>
          <div
            className={this.props.exercise === "light" ? "col-md-2 ex-btn active-box" : "col-md-2 ex-btn"}
            onClick={() => { this.props.eventEmitter.emit("updateExercise", "light") }}
            >Light Exercise</div>
          <div
            className={this.props.exercise === "moderate" ? "col-md-2 ex-btn active-box" : "col-md-2 ex-btn"}
            onClick={() => { this.props.eventEmitter.emit("updateExercise", "moderate") }}
            >Moderate Exercise</div>
          <div
            className={this.props.exercise === "heavy" ? "col-md-2 ex-btn active-box" : "col-md-2 ex-btn"}
            onClick={() => { this.props.eventEmitter.emit("updateExercise", "heavy") }}
            >Heavy Exercise</div>
          <div
            className={this.props.exercise === "extreme" ? "col-md-2 ex-btn active-box" : "col-md-2 ex-btn"}
