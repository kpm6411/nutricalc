  ...
  render() {
    return (
      <div>
        ...
        <div className="row">
          <div 
            className={this.props.sex == "Male" ? "col-md-5 sex-btn active-box" : "col-md-5 sex-btn"}
            onClick={() => { this.props.eventEmitter.emit("updateSex", "Male") }}
            >Male</div>
          <div 
            className={this.props.sex == "Female" ? "col-md-5 sex-btn active-box" : "col-md-5 sex-btn"}
